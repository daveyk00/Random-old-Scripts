...
## eg:
## CreateHTMLWithImages.ps1 -website www.google.com -sourcepath \\web03\blog\images\2016\1\3\ -HTMLFile \\web03\blog\20160103.html -YSize 100 -XSize 100
